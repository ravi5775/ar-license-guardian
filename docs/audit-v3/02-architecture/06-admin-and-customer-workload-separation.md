# 02-architecture-06 — Admin and customer workload separation

## Objective
Audit the repository area of admin and customer workload separation with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

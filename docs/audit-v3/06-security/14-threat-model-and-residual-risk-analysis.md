# 06-security-14 — Threat model and residual risk analysis

## Objective
Audit the repository area of threat model and residual risk analysis with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

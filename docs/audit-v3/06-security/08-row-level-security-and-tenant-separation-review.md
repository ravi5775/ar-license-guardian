# 06-security-08 — Row-level security and tenant separation review

## Objective
Audit the repository area of row-level security and tenant separation review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

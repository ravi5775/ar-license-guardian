# 06-security-10 — Content Security Policy and security-headers review

## Objective
Audit the repository area of content security policy and security-headers review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

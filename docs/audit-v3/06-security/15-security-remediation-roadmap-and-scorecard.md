# 06-security-15 — Security remediation roadmap and scorecard

## Objective
Audit the repository area of security remediation roadmap and scorecard with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

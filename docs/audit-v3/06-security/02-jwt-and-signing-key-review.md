# 06-security-02 — JWT and signing key review

## Objective
Audit the repository area of jwt and signing key review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

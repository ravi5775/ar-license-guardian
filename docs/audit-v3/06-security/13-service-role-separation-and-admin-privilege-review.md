# 06-security-13 — Service-role separation and admin privilege review

## Objective
Audit the repository area of service-role separation and admin privilege review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

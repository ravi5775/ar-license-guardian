# 06-security-04 — Customer binding and origin validation review

## Objective
Audit the repository area of customer binding and origin validation review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

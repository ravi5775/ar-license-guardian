# 08-devsecops-01 — CI workflow inventory and branch coverage review

## Objective
Audit the repository area of ci workflow inventory and branch coverage review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

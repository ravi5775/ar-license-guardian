# 08-devsecops-10 — DevSecOps scorecard and roadmap

## Objective
Audit the repository area of devsecops scorecard and roadmap with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

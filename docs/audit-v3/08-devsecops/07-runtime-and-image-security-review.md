# 08-devsecops-07 — Runtime and image security review

## Objective
Audit the repository area of runtime and image security review with the intent of producing an evidence-backed enterprise review for procurement and production-readiness assessment.

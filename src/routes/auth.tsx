  ...
  return (
    <div className="min-h-screen bg-background text-foreground grid lg:grid-cols-2">
      ...
      <div className="relative hidden lg:block overflow-hidden border-r border-border/60">
        ...
        <span
          aria-hidden
          className="absolute left-6 top-6 h-6 w-6 border-l border-t border-primary/50"
        />
        <span
          aria-hidden
          className="absolute right-6 bottom-6 h-6 w-6 border-r border-b border-primary/50"
        />
      ...
      <div className="relative flex items-center justify-center px-6 py-16">
        <span
          aria-hidden
          className="absolute right-6 top-6 h-6 w-6 border-r border-t border-primary/30"
        />
          ...
          <form onSubmit={handleSubmit} className="space-y-3" suppressHydrationWarning>
            {mode === "signup" && (
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label htmlFor="firstName" className="block text-xs text-muted-foreground mb-1.5">
                    First name
                  </label>
                  <input
                    id="firstName"
                ...
                <div>
                  <label htmlFor="lastName" className="block text-xs text-muted-foreground mb-1.5">
                    Last name
                  </label>
                  <input
                    id="lastName"
